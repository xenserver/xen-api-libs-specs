...
Patch4: libvirt-qdisk.patch
Patch5: libvirt-qdisk-fixup.patch
Patch6: libvirt-emulator.patch
...
%changelog
* Fri Apr 05 2013 Johnny Hughes <johnny@centos.org> - 0.10.2.4-1.el6.centos.alt
- modified to build xen and libxl on centos
